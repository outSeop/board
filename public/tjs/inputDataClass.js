...
var Username = /** @class */ (function () {
    ...
    Username.prototype.verifyDuplication = function () {
        return __awaiter(this, void 0, void 0, function () {
            var apiResponse, apiResponseJson;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/users/new', {
                            method: 'POST',
                            headers: {
    ...
    Username.prototype.verifyAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.verifyFormat();
...
var Name = /** @class */ (function () {
    function Name() {
        ...
        this.errorBox = document.getElementById('name-error');
        this.format = RegExp(/^[가-힣]*$/);
    }
    Name.prototype.verifyFormat = function () {
        if (this.format.test(this.input.value)) {
            this.validation = true;
        }
        else {
    ...
    Name.prototype.verifyAll = function () {
        this.verifyFormat();
    };
    return Name;
}());
